...
var m__7493__auto__ = (alandipert.storage_atom._get[goog.typeOf(x__7492__auto__)]);
if(!((m__7493__auto__ == null))){
return m__7493__auto__.call(null,this$,not_found);
} else {
var m__7493__auto____$1 = (alandipert.storage_atom._get["_"]);
if(!((m__7493__auto____$1 == null))){
return m__7493__auto____$1.call(null,this$,not_found);
} else {
...
var x__7492__auto__ = (((this$ == null))?null:this$);
var m__7493__auto__ = (alandipert.storage_atom._commit_BANG_[goog.typeOf(x__7492__auto__)]);
if(!((m__7493__auto__ == null))){
return m__7493__auto__.call(null,this$,value);
} else {
var m__7493__auto____$1 = (alandipert.storage_atom._commit_BANG_["_"]);
if(!((m__7493__auto____$1 == null))){
return m__7493__auto____$1.call(null,this$,value);
} else {
...
alandipert.storage_atom.StorageBackend.cljs$lang$ctorPrWriter = (function (this__7435__auto__,writer__7436__auto__,opt__7437__auto__){
return cljs.core._write.call(null,writer__7436__auto__,"alandipert.storage-atom/StorageBackend");
});
...
var G__11392 = atom;
cljs.core.add_watch.call(null,G__11392,new cljs.core.Keyword("alandipert.storage-atom","storage-watch","alandipert.storage-atom/storage-watch",1159565749),((function (G__11392,existing,debounce){
return (function (p1__11389_SHARP_,p2__11390_SHARP_,p3__11387_SHARP_,p4__11388_SHARP_){
if((alandipert.storage_atom._STAR_watch_active_STAR_) && (cljs.core.not_EQ_.call(null,p3__11387_SHARP_,p4__11388_SHARP_))){
return debounce.call(null,((function (G__11392,existing,debounce){
return (function (){
return alandipert.storage_atom._commit_BANG_.call(null,backend,p4__11388_SHARP_);
});})(G__11392,existing,debounce))
,(function (){var or__6824__auto__ = alandipert.storage_atom._STAR_storage_delay_STAR_;
...
var _STAR_watch_active_STAR_11396 = alandipert.storage_atom._STAR_watch_active_STAR_;
alandipert.storage_atom._STAR_watch_active_STAR_ = false;

try{return cljs.core.reset_BANG_.call(null,atom,default$);
}finally {alandipert.storage_atom._STAR_watch_active_STAR_ = _STAR_watch_active_STAR_11396;
}} else {
...
var _STAR_watch_active_STAR_11398 = alandipert.storage_atom._STAR_watch_active_STAR_;
alandipert.storage_atom._STAR_watch_active_STAR_ = false;
...
}finally {alandipert.storage_atom._STAR_watch_active_STAR_ = _STAR_watch_active_STAR_11398;
}} else {
return null;
}
} else {
...
return alandipert.storage_atom.maybe_update_backend.call(null,atom,storage,k,default$,p1__11399_SHARP_);
});})(default$))
);
});
/**
