...
reagent.impl.template.NativeWrapper.cljs$lang$ctorPrWriter = (function (this__7435__auto__,writer__7436__auto__,opt__7437__auto__){
return cljs.core._write.call(null,writer__7436__auto__,"reagent.impl.template/NativeWrapper");
});
...
var G__12826 = o;
(G__12826[reagent.impl.template.cached_prop_name.call(null,k)] = reagent.impl.template.convert_prop_value.call(null,v));
...
if(cljs.core.truth_((function (){var and__6812__auto__ = !((jsprops == null));
if(and__6812__auto__){
var and__6812__auto____$1 = jsprops.hasOwnProperty("onChange");
...
var G__12834 = jsprops;
(G__12834["defaultValue"] = value);

(G__12834["onChange"] = ((function (G__12834,v,value,on_change){
return (function (p1__12832_SHARP_){
return reagent.impl.template.input_handle_change.call(null,this$,on_change,p1__12832_SHARP_);
});})(G__12834,v,value,on_change))
);
...
var vec__12841 = cljs.core.next.call(null,cljs.core.re_matches.call(null,reagent.impl.template.re_tag,cljs.core.name.call(null,hiccup_tag)));
var tag = cljs.core.nth.call(null,vec__12841,(0),null);
var id = cljs.core.nth.call(null,vec__12841,(1),null);
var class$ = cljs.core.nth.call(null,vec__12841,(2),null);
...
var jsprops = ({"argv": v});
var temp__4661__auto___12846 = reagent.impl.template.key_from_vec.call(null,v);
if((temp__4661__auto___12846 == null)){
} else {
var key_12847 = temp__4661__auto___12846;
(jsprops["key"] = key_12847);
}

return (reagent.impl.util.react["createElement"])(c,jsprops);
});
reagent.impl.template.adapt_react_class = (function reagent$impl$template$adapt_react_class(c){
var G__12849 = (new reagent.impl.template.NativeWrapper());
(G__12849["name"] = c);
...
args__7940__auto__.push((arguments[i__7934__auto___12855]));
...
return reagent.impl.template.hiccup_err.cljs$core$IFn$_invoke$arity$variadic((arguments[(0)]),argseq__7941__auto__);
});
...
reagent.impl.template.hiccup_err.cljs$lang$applyTo = (function (seq12852){
var G__12853 = cljs.core.first.call(null,seq12852);
var seq12852__$1 = cljs.core.next.call(null,seq12852);
return reagent.impl.template.hiccup_err.cljs$core$IFn$_invoke$arity$variadic(G__12853,seq12852__$1);
});
...
break;
default:
var G__12860 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.call(null,n,(0),pos),cljs.core.assoc.call(null,v,(0),cljs.core.subs.call(null,n,(pos + (1))))], null);
v = G__12860;
continue;
...
var n__7747__auto___12863 = a.length;
var i_12864 = (0);
while(true){
if((i_12864 < n__7747__auto___12863)){
(a[i_12864] = reagent.impl.template.as_element.call(null,(a[i_12864])));
...
var a = cljs.core.into_array.call(null,s);
var n__7747__auto___12866 = a.length;
var i_12867 = (0);
while(true){
if((i_12867 < n__7747__auto___12866)){
var val_12868 = (a[i_12867]);
if((cljs.core.vector_QMARK_.call(null,val_12868)) && ((reagent.impl.template.key_from_vec.call(null,val_12868) == null))){
(o["no-key"] = true);
} else {
}

(a[i_12867] = reagent.impl.template.as_element.call(null,val_12868));
...
var ctx = ({});
var vec__12873 = reagent.ratom.check_derefs.call(null,((function (ctx){
return (function (){
return reagent.impl.template.expand_seq_dev.call(null,x,ctx);
});})(ctx))
);
var res = cljs.core.nth.call(null,vec__12873,(0),null);
var derefed = cljs.core.nth.call(null,vec__12873,(1),null);
...
var G__12877 = (cljs.core.count.call(null,argv) - first_child);
switch (G__12877) {
case (0):
...
break;
default:
return (reagent.impl.util.react["createElement"]).apply(null,cljs.core.reduce_kv.call(null,((function (G__12877){
