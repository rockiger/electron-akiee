...
var args10968 = [];
var len__7933__auto___10972 = arguments.length;
var i__7934__auto___10973 = (0);
while(true){
if((i__7934__auto___10973 < len__7933__auto___10972)){
args10968.push((arguments[i__7934__auto___10973]));

var G__10974 = (i__7934__auto___10973 + (1));
i__7934__auto___10973 = G__10974;
continue;
} else {
}
break;
...
var G__10971 = new cljs.core.PersistentArrayMap(null, 5, [new cljs.core.Keyword(null,"report-counters","report-counters",-1702609242),new cljs.core.PersistentArrayMap(null, 4, [new cljs.core.Keyword(null,"test","test",577538877),(0),new cljs.core.Keyword(null,"pass","pass",1574159993),(0),new cljs.core.Keyword(null,"fail","fail",1706214930),(0),new cljs.core.Keyword(null,"error","error",-978969032),(0)], null),new cljs.core.Keyword(null,"testing-vars","testing-vars",-2114769150),cljs.core.List.EMPTY,new cljs.core.Keyword(null,"testing-contexts","testing-contexts",-1485646523),cljs.core.List.EMPTY,new cljs.core.Keyword(null,"formatter","formatter",-483008823),cljs.core.pr_str,new cljs.core.Keyword(null,"reporter","reporter",-805360621),reporter], null);
if(cljs.core._EQ_.call(null,new cljs.core.Keyword("cljs.test","pprint","cljs.test/pprint",1627393641),reporter)){
return cljs.core.assoc.call(null,G__10971,new cljs.core.Keyword(null,"reporter","reporter",-805360621),new cljs.core.Keyword("cljs.test","default","cljs.test/default",-1581405322),new cljs.core.Keyword(null,"formatter","formatter",-483008823),cljs.pprint.pprint);
} else {
return G__10971;
}
});
...
var or__6824__auto__ = cljs.test._STAR_current_env_STAR_;
...
var len__7933__auto___10979 = arguments.length;
var i__7934__auto___10980 = (0);
while(true){
if((i__7934__auto___10980 < len__7933__auto___10979)){
args__7940__auto__.push((arguments[i__7934__auto___10980]));

var G__10981 = (i__7934__auto___10980 + (1));
i__7934__auto___10980 = G__10981;
continue;
} else {
}
break;
...
return cljs.test.update_current_env_BANG_.cljs$core$IFn$_invoke$arity$variadic((arguments[(0)]),(arguments[(1)]),argseq__7941__auto__);
});
...
cljs.test.update_current_env_BANG_.cljs$lang$applyTo = (function (seq10976){
...
return cljs.test.update_current_env_BANG_.cljs$core$IFn$_invoke$arity$variadic(G__10977,G__10978,seq10976__$2);
});
...
var file = cljs.core.get.call(null,map__10985__$1,new cljs.core.Keyword(null,"file","file",-1269645878));
var line = cljs.core.get.call(null,map__10985__$1,new cljs.core.Keyword(null,"line","line",212345235));
var column = cljs.core.get.call(null,map__10985__$1,new cljs.core.Keyword(null,"column","column",2078222095));
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(cljs.core.reverse.call(null,cljs.core.map.call(null,((function (map__10985,map__10985__$1,file,line,column){
return (function (p1__10982_SHARP_){
return new cljs.core.Keyword(null,"name","name",1843675177).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,p1__10982_SHARP_));
});})(map__10985,map__10985__$1,file,line,column))
 ...
 */
cljs.test.report = (function (){var method_table__7757__auto__ = cljs.core.atom.call(null,cljs.core.PersistentArrayMap.EMPTY);
...
return (new cljs.core.MultiFn(cljs.core.symbol.call(null,"cljs.test","report"),((function (method_table__7757__auto__,prefer_table__7758__auto__,method_cache__7759__auto__,cached_hierarchy__7760__auto__,hierarchy__7761__auto__){
return (function (m){
...
var formatter_fn = (function (){var or__6824__auto__ = new cljs.core.Keyword(null,"formatter","formatter",-483008823).cljs$core$IFn$_invoke$arity$1(cljs.test.get_current_env.call(null));
if(cljs.core.truth_(or__6824__auto__)){
return or__6824__auto__;
} else {
...
var temp__4657__auto___10987 = new cljs.core.Keyword(null,"message","message",-406056002).cljs$core$IFn$_invoke$arity$1(m);
if(cljs.core.truth_(temp__4657__auto___10987)){
var message_10988 = temp__4657__auto___10987;
cljs.core.println.call(null,message_10988);
} else {
}
...
var temp__4657__auto___10989 = new cljs.core.Keyword(null,"message","message",-406056002).cljs$core$IFn$_invoke$arity$1(m);
if(cljs.core.truth_(temp__4657__auto___10989)){
var message_10990 = temp__4657__auto___10989;
cljs.core.println.call(null,message_10990);
} else {
}
...
var temp__4655__auto__ = (function (){var and__6812__auto__ = typeof exception.stack === 'string';
if(and__6812__auto__){
var G__11000 = exception.stack;
var G__11000__$1 = (((G__11000 == null))?null:clojure.string.split_lines.call(null,G__11000));
var G__11000__$2 = (((G__11000__$1 == null))?null:cljs.core.get.call(null,G__11000__$1,depth));
if((G__11000__$2 == null)){
return null;
} else {
return clojure.string.trim.call(null,G__11000__$2);
}
} else {
...
var vec__11001 = cljs.test.js_line_and_column.call(null,stack_element);
var line = cljs.core.nth.call(null,vec__11001,(0),null);
var column = cljs.core.nth.call(null,vec__11001,(1),null);
var vec__11004 = cljs.test.mapped_line_and_column.call(null,fname,line,column);
var fname__$1 = cljs.core.nth.call(null,vec__11004,(0),null);
var line__$1 = cljs.core.nth.call(null,vec__11004,(1),null);
var column__$1 = cljs.core.nth.call(null,vec__11004,(2),null);
...
var m__$1 = (function (){var G__11008 = (((new cljs.core.Keyword(null,"type","type",1174270348).cljs$core$IFn$_invoke$arity$1(m) instanceof cljs.core.Keyword))?new cljs.core.Keyword(null,"type","type",1174270348).cljs$core$IFn$_invoke$arity$1(m).fqn:null);
switch (G__11008) {
case "fail":
...
var G__11014 = (function (){var G__11013 = cljs.core.rest.call(null,fns);
...
return cljs.core.concat.call(null,obj,G__11013);
} else {
return G__11013;
}
})();
...
return cljs.core.vary_meta.call(null,G__11016,cljs.core.assoc,new cljs.core.Keyword("cljs.test","block?","cljs.test/block?",686379965),true);
}
});
...
var G__11020 = (((e instanceof cljs.core.Keyword))?e.fqn:null);
switch (G__11020) {
...
var vec__11025 = fixtures_types.call(null);
var type = cljs.core.nth.call(null,vec__11025,(0),null);
var types = vec__11025;
...
return cljs.core.map.call(null,(function (p__11037){
var vec__11038 = p__11037;
var ns = cljs.core.nth.call(null,vec__11038,(0),null);
var vars__$1 = cljs.core.nth.call(null,vec__11038,(1),null);
return ((function (vec__11038,ns,vars__$1){
return (function (){
...
var G__11041 = (((cljs.test.execution_strategy.call(null,once_fixtures,each_fixtures) instanceof cljs.core.Keyword))?cljs.test.execution_strategy.call(null,once_fixtures,each_fixtures).fqn:null);
switch (G__11041) {
case "async":
...
return new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [((function (each_fixture_fn,G__11041,env,once_fixtures,each_fixtures,vec__11038,ns,vars__$1){
return (function (){
return cljs.test.join_fixtures.call(null,once_fixtures).call(null,((function (each_fixture_fn,G__11041,env,once_fixtures,each_fixtures,vec__11038,ns,vars__$1){
return (function (){
var seq__11042 = cljs.core.seq.call(null,vars__$1);
var chunk__11043 = null;
var count__11044 = (0);
var i__11045 = (0);
while(true){
if((i__11045 < count__11044)){
var v = cljs.core._nth.call(null,chunk__11043,i__11045);
var temp__4657__auto___11047 = new cljs.core.Keyword(null,"test","test",577538877).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,v));
if(cljs.core.truth_(temp__4657__auto___11047)){
var t_11048 = temp__4657__auto___11047;
each_fixture_fn.call(null,((function (seq__11042,chunk__11043,count__11044,i__11045,t_11048,temp__4657__auto___11047,v,each_fixture_fn,G__11041,env,once_fixtures,each_fixtures,vec__11038,ns,vars__$1){
return (function (){
return cljs.test.run_block.call(null,cljs.test.test_var_block_STAR_.call(null,v,cljs.test.disable_async.call(null,t_11048)));
});})(seq__11042,chunk__11043,count__11044,i__11045,t_11048,temp__4657__auto___11047,v,each_fixture_fn,G__11041,env,once_fixtures,each_fixtures,vec__11038,ns,vars__$1))
);
} else {
}

var G__11049 = seq__11042;
var G__11050 = chunk__11043;
var G__11051 = count__11044;
var G__11052 = (i__11045 + (1));
seq__11042 = G__11049;
chunk__11043 = G__11050;
count__11044 = G__11051;
i__11045 = G__11052;
continue;
} else {
var temp__4657__auto__ = cljs.core.seq.call(null,seq__11042);
if(temp__4657__auto__){
var seq__11042__$1 = temp__4657__auto__;
if(cljs.core.chunked_seq_QMARK_.call(null,seq__11042__$1)){
var c__7643__auto__ = cljs.core.chunk_first.call(null,seq__11042__$1);
var G__11053 = cljs.core.chunk_rest.call(null,seq__11042__$1);
var G__11054 = c__7643__auto__;
var G__11055 = cljs.core.count.call(null,c__7643__auto__);
var G__11056 = (0);
seq__11042 = G__11053;
chunk__11043 = G__11054;
count__11044 = G__11055;
i__11045 = G__11056;
continue;
} else {
var v = cljs.core.first.call(null,seq__11042__$1);
var temp__4657__auto___11057__$1 = new cljs.core.Keyword(null,"test","test",577538877).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,v));
if(cljs.core.truth_(temp__4657__auto___11057__$1)){
var t_11058 = temp__4657__auto___11057__$1;
each_fixture_fn.call(null,((function (seq__11042,chunk__11043,count__11044,i__11045,t_11058,temp__4657__auto___11057__$1,v,seq__11042__$1,temp__4657__auto__,each_fixture_fn,G__11041,env,once_fixtures,each_fixtures,vec__11038,ns,vars__$1){
return (function (){
return cljs.test.run_block.call(null,cljs.test.test_var_block_STAR_.call(null,v,cljs.test.disable_async.call(null,t_11058)));
});})(seq__11042,chunk__11043,count__11044,i__11045,t_11058,temp__4657__auto___11057__$1,v,seq__11042__$1,temp__4657__auto__,each_fixture_fn,G__11041,env,once_fixtures,each_fixtures,vec__11038,ns,vars__$1))
);
} else {
}

var G__11059 = cljs.core.next.call(null,seq__11042__$1);
var G__11060 = null;
var G__11061 = (0);
var G__11062 = (0);
seq__11042 = G__11059;
chunk__11043 = G__11060;
count__11044 = G__11061;
i__11045 = G__11062;
continue;
}
} else {
...
});})(each_fixture_fn,G__11041,env,once_fixtures,each_fixtures,vec__11038,ns,vars__$1))
);
});})(each_fixture_fn,G__11041,env,once_fixtures,each_fixtures,vec__11038,ns,vars__$1))
], null);
