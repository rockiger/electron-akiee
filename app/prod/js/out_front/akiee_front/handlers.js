...
return akiee_front.fileoperations.save_task_file.call(null,akiee_front.node.lon__GT_md.call(null,akiee_front.app_db.nodes.call(null)),akiee_front.app_db.task_file_path.call(null),akiee_front.app_db.changed_QMARK_.call(null),akiee_front.app_db.set_changed_BANG_,(function (p1__11426_SHARP_,p2__11427_SHARP_){
...
var confirmation_11432 = confirm("There is already a tasklist in this location.\nDo you really want to overwrite it?");
if(cljs.core.not.call(null,confirmation_11432)){
...
akiee_front.filewatcher.watch_file.call(null,fpth,(function (p1__11433_SHARP_,p2__11434_SHARP_){
return akiee_front.filewatcher.on_file_change.call(null,p1__11433_SHARP_,p2__11434_SHARP_,akiee_front.handlers.on_file_change_reload.call(null,pth));
}));
...
return akiee_front.filewatcher.on_file_change.call(null,p1__11439_SHARP_,p2__11440_SHARP_,akiee_front.handlers.on_file_change_reload.call(null,pth));
});})(fpth,pth))
);
} else {
return null;
