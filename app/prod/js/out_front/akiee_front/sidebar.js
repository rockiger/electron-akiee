...
})())?new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"select#sidebar-task-project.form-control","select#sidebar-task-project.form-control",-556150370),new cljs.core.PersistentArrayMap(null, 6, [new cljs.core.Keyword(null,"name","name",1843675177),"task-project",new cljs.core.Keyword(null,"defaultValue","defaultValue",-586131910),new cljs.core.Keyword(null,"project","project",1124394579).cljs$core$IFn$_invoke$arity$1(node),new cljs.core.Keyword(null,"on-blur","on-blur",814300747),akiee_front.handlers.onblur_sidebar_project,new cljs.core.Keyword(null,"on-submit","on-submit",1227871159),akiee_front.handlers.onblur_sidebar_project,new cljs.core.Keyword(null,"on-change","on-change",-732046149),akiee_front.handlers.onblur_sidebar_project,new cljs.core.Keyword(null,"on-click","on-click",1632826543),akiee_front.handlers.submit_sidebar_project], null),(function (){var iter__7612__auto__ = (function akiee_front$sidebar$project_$_iter__14320(s__14321){
...
var c__7610__auto__ = cljs.core.chunk_first.call(null,s__14321__$2);
var size__7611__auto__ = cljs.core.count.call(null,c__7610__auto__);
var b__14323 = cljs.core.chunk_buffer.call(null,size__7611__auto__);
if((function (){var i__14322 = (0);
while(true){
if((i__14322 < size__7611__auto__)){
var p = cljs.core._nth.call(null,c__7610__auto__,i__14322);
cljs.core.chunk_append.call(null,b__14323,cljs.core.with_meta(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"option","option",65132272),p], null),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"key","key",-1516042587),p], null)));
