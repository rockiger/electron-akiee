...
if(cljs.core.truth_((function (){var or__26569__auto__ = cljs.core.empty_QMARK_.call(null,new cljs.core.Keyword(null,"task-location","task-location",1147747826).cljs$core$IFn$_invoke$arity$1(cljs.core.deref.call(null,akiee_front.app_db.conf_state)));
if(or__26569__auto__){
...
if(cljs.core.truth_((function (){var or__26569__auto__ = cljs.core.re_find.call(null,cljs.core.re_pattern.call(null,[cljs.core.str.cljs$core$IFn$_invoke$arity$1("(?i)"),cljs.core.str.cljs$core$IFn$_invoke$arity$1(new cljs.core.Keyword(null,"ss","ss",-1463049578).cljs$core$IFn$_invoke$arity$1(cljs.core.deref.call(null,gs)))].join('')),new cljs.core.Keyword(null,"headline","headline",-157157727).cljs$core$IFn$_invoke$arity$1(x));
if(cljs.core.truth_(or__26569__auto__)){
return or__26569__auto__;
} else {
var or__26569__auto____$1 = cljs.core.re_find.call(null,cljs.core.re_pattern.call(null,[cljs.core.str.cljs$core$IFn$_invoke$arity$1("(?i)"),cljs.core.str.cljs$core$IFn$_invoke$arity$1(new cljs.core.Keyword(null,"ss","ss",-1463049578).cljs$core$IFn$_invoke$arity$1(cljs.core.deref.call(null,gs)))].join('')),akiee_front.node.tags_string.call(null,x));
if(cljs.core.truth_(or__26569__auto____$1)){
return or__26569__auto____$1;
} else {
...
var args30641 = [];
var len__27678__auto___30644 = arguments.length;
var i__27679__auto___30645 = (0);
while(true){
if((i__27679__auto___30645 < len__27678__auto___30644)){
args30641.push((arguments[i__27679__auto___30645]));

var G__30646 = (i__27679__auto___30645 + (1));
i__27679__auto___30645 = G__30646;
continue;
} else {
}
break;
...
break;
default:
throw (new Error([cljs.core.str.cljs$core$IFn$_invoke$arity$1("Invalid arity: "),cljs.core.str.cljs$core$IFn$_invoke$arity$1(args30641.length)].join('')));
