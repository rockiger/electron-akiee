...
return new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"h4","h4",2004862993),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"on-click","on-click",1632826543),akiee_front.handlers.onclick_hdln], null),(cljs.core.truth_((function (){var and__26557__auto__ = akiee_front.app_db.selected.call(null);
...
return iter__27357__auto__.call(null,akiee_front.app_db.projects.call(null));
...
var style = (cljs.core.truth_((function (){var and__26557__auto__ = akiee_front.app_db.selected.call(null);
if(cljs.core.truth_(and__26557__auto__)){
...
var span_style = (cljs.core.truth_((function (){var and__26557__auto__ = akiee_front.app_db.selected.call(null);
if(cljs.core.truth_(and__26557__auto__)){
return cljs.core._EQ_.call(null,akiee_front.app_db.editable.call(null),"scheduled");
} else {
return and__26557__auto__;
...
return new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"div#sidebar-tags","div#sidebar-tags",-2057064167),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"on-click","on-click",1632826543),akiee_front.handlers.onclick_tags], null),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"span.details-left","span.details-left",585347392),"Tags:"], null),(cljs.core.truth_((function (){var and__26557__auto__ = akiee_front.app_db.selected.call(null);
if(cljs.core.truth_(and__26557__auto__)){
return cljs.core._EQ_.call(null,akiee_front.app_db.editable.call(null),"tags");
} else {
return and__26557__auto__;
}
})())?new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"input#sidebar-tags-form.form-control","input#sidebar-tags-form.form-control",-1410782008),new cljs.core.PersistentArrayMap(null, 4, [new cljs.core.Keyword(null,"type","type",1174270348),"text",new cljs.core.Keyword(null,"default-value","default-value",232220170),akiee_front.node.tags_string.call(null,node),new cljs.core.Keyword(null,"on-blur","on-blur",814300747),akiee_front.handlers.onblur_sidebar_tags,new cljs.core.Keyword(null,"on-submit","on-submit",1227871159),akiee_front.handlers.onblur_sidebar_tags], null)], null):new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"span","span",1394872991),(function (){var or__26569__auto__ = akiee_front.node.tags_string.call(null,node);
