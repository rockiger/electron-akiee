...
var G__8579 = o;
(G__8579[reagent.impl.template.cached_prop_name.call(null,k)] = reagent.impl.template.convert_prop_value.call(null,v));
...
return (function() { 
var G__8580__delegate = function (args){
...
var G__8587 = jsprops;
(G__8587["defaultValue"] = value);

(G__8587["onChange"] = ((function (G__8587,v,value,on_change){
return (function (p1__8585_SHARP_){
return reagent.impl.template.input_handle_change.call(null,this$,on_change,p1__8585_SHARP_);
});})(G__8587,v,value,on_change))
);
...
var jsprops = ({"argv": v});
var temp__4661__auto___8599 = reagent.impl.template.key_from_vec.call(null,v);
if((temp__4661__auto___8599 == null)){
} else {
var key_8600 = temp__4661__auto___8599;
(jsprops["key"] = key_8600);
}

return (reagent.impl.util.react["createElement"])(c,jsprops);
});
reagent.impl.template.adapt_react_class = (function reagent$impl$template$adapt_react_class(c){
var G__8602 = (new reagent.impl.template.NativeWrapper());
(G__8602["name"] = c);
...
var len__7933__auto___8607 = arguments.length;
var i__7934__auto___8608 = (0);
while(true){
if((i__7934__auto___8608 < len__7933__auto___8607)){
args__7940__auto__.push((arguments[i__7934__auto___8608]));

var G__8609 = (i__7934__auto___8608 + (1));
i__7934__auto___8608 = G__8609;
continue;
} else {
}
break;
...
return reagent.impl.template.hiccup_err.cljs$core$IFn$_invoke$arity$variadic(G__8606,seq8605__$1);
});
...
break;
default:
var G__8613 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.call(null,n,(0),pos),cljs.core.assoc.call(null,v,(0),cljs.core.subs.call(null,n,(pos + (1))))], null);
v = G__8613;
continue;
...
var n__7747__auto___8616 = a.length;
var i_8617 = (0);
while(true){
if((i_8617 < n__7747__auto___8616)){
(a[i_8617] = reagent.impl.template.as_element.call(null,(a[i_8617])));

var G__8618 = (i_8617 + (1));
i_8617 = G__8618;
continue;
} else {
}
...
var a = cljs.core.into_array.call(null,s);
var n__7747__auto___8619 = a.length;
var i_8620 = (0);
while(true){
if((i_8620 < n__7747__auto___8619)){
var val_8621 = (a[i_8620]);
if((cljs.core.vector_QMARK_.call(null,val_8621)) && ((reagent.impl.template.key_from_vec.call(null,val_8621) == null))){
(o["no-key"] = true);
} else {
}

(a[i_8620] = reagent.impl.template.as_element.call(null,val_8621));
...
var ctx = ({});
var vec__8626 = reagent.ratom.check_derefs.call(null,((function (ctx){
return (function (){
return reagent.impl.template.expand_seq_dev.call(null,x,ctx);
});})(ctx))
);
var res = cljs.core.nth.call(null,vec__8626,(0),null);
var derefed = cljs.core.nth.call(null,vec__8626,(1),null);
...
var G__8630 = (cljs.core.count.call(null,argv) - first_child);
switch (G__8630) {
case (0):
...
break;
default:
return (reagent.impl.util.react["createElement"]).apply(null,cljs.core.reduce_kv.call(null,((function (G__8630){
