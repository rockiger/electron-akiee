...
var m__27238__auto__ = (alandipert.storage_atom._get[goog.typeOf(x__27237__auto__)]);
if(!((m__27238__auto__ == null))){
return m__27238__auto__.call(null,this$,not_found);
} else {
var m__27238__auto____$1 = (alandipert.storage_atom._get["_"]);
if(!((m__27238__auto____$1 == null))){
return m__27238__auto____$1.call(null,this$,not_found);
} else {
...
var x__27237__auto__ = (((this$ == null))?null:this$);
var m__27238__auto__ = (alandipert.storage_atom._commit_BANG_[goog.typeOf(x__27237__auto__)]);
if(!((m__27238__auto__ == null))){
return m__27238__auto__.call(null,this$,value);
} else {
var m__27238__auto____$1 = (alandipert.storage_atom._commit_BANG_["_"]);
if(!((m__27238__auto____$1 == null))){
return m__27238__auto____$1.call(null,this$,value);
} else {
...
alandipert.storage_atom.StorageBackend.cljs$lang$ctorPrWriter = (function (this__27180__auto__,writer__27181__auto__,opt__27182__auto__){
return cljs.core._write.call(null,writer__27181__auto__,"alandipert.storage-atom/StorageBackend");
});
...
var G__27895 = atom;
cljs.core.add_watch.call(null,G__27895,new cljs.core.Keyword("alandipert.storage-atom","storage-watch","alandipert.storage-atom/storage-watch",1159565749),((function (G__27895,existing,debounce){
return (function (p1__27892_SHARP_,p2__27893_SHARP_,p3__27890_SHARP_,p4__27891_SHARP_){
if((alandipert.storage_atom._STAR_watch_active_STAR_) && (cljs.core.not_EQ_.call(null,p3__27890_SHARP_,p4__27891_SHARP_))){
return debounce.call(null,((function (G__27895,existing,debounce){
return (function (){
return alandipert.storage_atom._commit_BANG_.call(null,backend,p4__27891_SHARP_);
});})(G__27895,existing,debounce))
,(function (){var or__26569__auto__ = alandipert.storage_atom._STAR_storage_delay_STAR_;
...
var _STAR_watch_active_STAR_27899 = alandipert.storage_atom._STAR_watch_active_STAR_;
alandipert.storage_atom._STAR_watch_active_STAR_ = false;

try{return cljs.core.reset_BANG_.call(null,atom,default$);
}finally {alandipert.storage_atom._STAR_watch_active_STAR_ = _STAR_watch_active_STAR_27899;
}} else {
...
var _STAR_watch_active_STAR_27901 = alandipert.storage_atom._STAR_watch_active_STAR_;
alandipert.storage_atom._STAR_watch_active_STAR_ = false;
...
}finally {alandipert.storage_atom._STAR_watch_active_STAR_ = _STAR_watch_active_STAR_27901;
}} else {
return null;
}
} else {
...
return alandipert.storage_atom.maybe_update_backend.call(null,atom,storage,k,default$,p1__27902_SHARP_);
});})(default$))
);
});
/**
