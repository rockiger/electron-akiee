...
return (new CustomEvent(event_name,(function (){var obj14621 = {"detail":data};
return obj14621;
})()));
} else {
...
if(cljs.core.truth_((function (){var and__6812__auto__ = figwheel.client.utils.html_env_QMARK_.call(null);
if(cljs.core.truth_(and__6812__auto__)){
var and__6812__auto____$1 = (window["CustomEvent"]);
...
var args14626 = [];
var len__7933__auto___14632 = arguments.length;
var i__7934__auto___14633 = (0);
while(true){
if((i__7934__auto___14633 < len__7933__auto___14632)){
args14626.push((arguments[i__7934__auto___14633]));

var G__14634 = (i__7934__auto___14633 + (1));
i__7934__auto___14633 = G__14634;
continue;
} else {
}
break;
...
break;
default:
throw (new Error([cljs.core.str.cljs$core$IFn$_invoke$arity$1("Invalid arity: "),cljs.core.str.cljs$core$IFn$_invoke$arity$1(args14626.length)].join('')));
...
var f = (function (){var pred__14629 = cljs.core._EQ_;
var expr__14630 = (cljs.core.truth_(figwheel.client.utils.html_env_QMARK_.call(null))?level:new cljs.core.Keyword(null,"info","info",-317069002));
if(cljs.core.truth_(pred__14629.call(null,new cljs.core.Keyword(null,"warn","warn",-436710552),expr__14630))){
return ((function (pred__14629,expr__14630){
return (function (p1__14622_SHARP_){
return console.warn(p1__14622_SHARP_);
});
;})(pred__14629,expr__14630))
} else {
if(cljs.core.truth_(pred__14629.call(null,new cljs.core.Keyword(null,"debug","debug",-1608172596),expr__14630))){
return ((function (pred__14629,expr__14630){
return (function (p1__14623_SHARP_){
return console.debug(p1__14623_SHARP_);
});
;})(pred__14629,expr__14630))
} else {
if(cljs.core.truth_(pred__14629.call(null,new cljs.core.Keyword(null,"error","error",-978969032),expr__14630))){
return ((function (pred__14629,expr__14630){
return (function (p1__14624_SHARP_){
return console.error(p1__14624_SHARP_);
});
;})(pred__14629,expr__14630))
} else {
return ((function (pred__14629,expr__14630){
return (function (p1__14625_SHARP_){
return console.log(p1__14625_SHARP_);
});
;})(pred__14629,expr__14630))
}
}
...
figwheel.client.utils.eval_helper = (function figwheel$client$utils$eval_helper(code,p__14636){
...
var opts = map__14639__$1;
var eval_fn = cljs.core.get.call(null,map__14639__$1,new cljs.core.Keyword(null,"eval-fn","eval-fn",-1111644294));
...
return new_def.callback(p1__14641_SHARP_);
});})(new_def))
);
...
var ky = cljs.core.nth.call(null,vec__14643,(0),null);
...
var args14646 = [];
var len__7933__auto___14649 = arguments.length;
var i__7934__auto___14650 = (0);
while(true){
if((i__7934__auto___14650 < len__7933__auto___14649)){
args14646.push((arguments[i__7934__auto___14650]));

var G__14651 = (i__7934__auto___14650 + (1));
i__7934__auto___14650 = G__14651;
continue;
} else {
}
break;
...
break;
default:
throw (new Error([cljs.core.str.cljs$core$IFn$_invoke$arity$1("Invalid arity: "),cljs.core.str.cljs$core$IFn$_invoke$arity$1(args14646.length)].join('')));
...
if(cljs.core.truth_((function (){var and__6812__auto__ = typeof localStorage !== 'undefined';
